...
export function update() {
	if (onSnake(food)) {
		//looks if the food is on the snake
		...
		document.getElementById("scoreTrack").value = score;
	}
	// scoreElement.innerHTML += score;
	// scoreElement2.innerHTML += score;
...
function getRandomFoodPosition() {
	//looks if there is food on the board, and if there isnt makes sure food doenst spawn on the snake
	let newFoodPosition;
